...
public class RespuestaServiceImpl implements RespuestaService {
    ...
    public List<Map<String, Object>> getAll(Long idAlumno, Long idEncuesta) {
        return repository.getRespuestasAlumnoEncuesta(idAlumno, idEncuesta);
    }
    ...
    public boolean update(Long id, RespuestaRequest request) {
        ...
        return repository.updateRespuesta(id, model) > 0;
    }

    @Override
    public boolean delete(Long id) {
        return repository.deleteRespuesta(id) > 0;
    }

    @Override
    public boolean completarEncuesta(Long idEncuesta, Long idAlumno) {
        return repository.completarEncuesta(idEncuesta, idAlumno) > 0;
    }
}
